  ...
  exports.image = function (img, opts, done) {
    ...
    var complete = function (err, encoded, cacheable) {
      ...
      if (
        ...
        encoded &&
        opts.maxImageSize &&
        encoded.length > opts.maxImageSize
      ) {
        err =
          "Skipping " + img + " (greater than " + opts.maxImageSize + " bytes)";
      }
